...
gdino_state_prompt = {
    "pos": ["broken {}", "{} with crack"], 
    "neg": ["{}", "flawless", "{s}"]
}

gdino_object_prompt = {
    "clock": ["clock", "dial", "meter", "digital"],
    "silicone bucket": ["bucket", "silicone bucket", "glass barrel"],
    "cover plate": ["hole", "plate", "cover plate"], 
    "insulator": ["insulator"]
}

def encode_text_with_prompt_ensemble_seg(model, objs, tokenizer, device):
    ...
    prompt_templates = ['a bad photo of a {}.', 'a low resolution photo of the {}.', 'a bad photo of the {}.', 'a cropped photo of the {}.', 
                        ...
                        'a photo of one {}.', 'a close-up photo of the {}.', 'a photo of a {}.', 'a low resolution photo of a {}.', 'a photo of a large {}.', 
                        'a blurry photo of a {}.', 'a jpeg corrupted photo of the {}.', 'a good photo of a {}.', 'a photo of the small {}.', 
                        'a photo of the large {}.', 'a black and white photo of a {}.', 'a dark photo of a {}.', 'a photo of a cool {}.', 
                        'a photo of a small {}.', 'there is a {} in the scene.', 'there is the {} in the scene.', 'this is a {} in the scene.', 
...
texture_list = ['carpet', 'leather','grid', 'tile', 'wood']

class_mapping = {"macaroni1":"macaroni",
"macaroni2":"macaroni",
}

def encode_text_with_prompt_ensemble_cls(model, objs, tokenizer, device):
